...
var random_number =  Math.floor((Math.random(quick_draw_data_set)*array_1.length)+1) 
console.log(random_number = quick_draw_data_set);

random_sketch = Math.floor((Math.random(quick_draw_data_set)*array_1.length)+1)
console.log(random_sketch = quick_draw_data_set)
...
function check_sketch() {
   ...
   console_log(results);
   draw = document.getElementById('Sketch_to_be_drawn');
}
